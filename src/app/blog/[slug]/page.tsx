  ...
  return (
    <PageTransition>
      ...
      <main className="flex min-h-screen flex-col bg-background text-foreground pb-24">
        {/* Hero Area */}
        <div
          className={`w-full pt-32 pb-24 bg-gradient-to-br ${post.gradient} relative overflow-hidden`}
        >
          ...
          <aside className="lg:w-1/3">
            <div className="sticky top-24 space-y-8">
              <div className="glass p-6 rounded-2xl border border-border/50">
                ...
                <p className="text-sm text-muted-foreground">
                  Senior designer passionate about creating intuitive and
                  ...
                  {relatedPosts.map((related) => (
                    ...
                    >
                      <div className="flex gap-4 items-center">
                        <div
                          className={`w-16 h-16 rounded-md bg-gradient-to-br ${related.gradient} shrink-0`}
                        />
                        <div>
